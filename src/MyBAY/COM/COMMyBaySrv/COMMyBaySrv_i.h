...
EXTERN_C const IID IID_ICOMMyBay;
    ...
    public:
        ...
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE getMessage( 
            /* [in] */ ULONG sessionId,
            /* [out] */ BOOL *einBoolwasIchNichtWeiﬂ,
...
#define ICOMMyBay_getMessage(This,sessionId,einBoolwasIchNichtWeiﬂ,messageType,message,errMsg)	\
    ( (This)->lpVtbl -> getMessage(This,sessionId,einBoolwasIchNichtWeiﬂ,messageType,message,errMsg) ) 
