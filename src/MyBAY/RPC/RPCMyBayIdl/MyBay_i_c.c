...
static const RPC_CLIENT_INTERFACE MyBay_i___RpcClientInterface =
    {
...
RPC_IF_HANDLE MyBay_i_v1_0_c_ifspec = (RPC_IF_HANDLE)& MyBay_i___RpcClientInterface;

extern const MIDL_STUB_DESC MyBay_i_StubDesc;

static RPC_BINDING_HANDLE MyBay_i__MIDL_AutoBindHandle;
    ...
    /* [out] */ unsigned long *sessionId)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&MyBay_i_StubDesc,
                  (PFORMAT_STRING) &MyBay_i__MIDL_ProcFormatString.Format[0],
    ...
    /* [in] */ unsigned long sessionId)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&MyBay_i_StubDesc,
                  (PFORMAT_STRING) &MyBay_i__MIDL_ProcFormatString.Format[48],
    ...
    /* [out] */ unsigned long *auctionNumber)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&MyBay_i_StubDesc,
                  (PFORMAT_STRING) &MyBay_i__MIDL_ProcFormatString.Format[84],
                  ( unsigned char * )&sessionId);
    return ( error_status_t  )_RetVal.Simple;
    ...
    /* [in] */ unsigned long auctionNumber)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&MyBay_i_StubDesc,
                  (PFORMAT_STRING) &MyBay_i__MIDL_ProcFormatString.Format[138],
                  ( unsigned char * )&sessionId);
    return ( error_status_t  )_RetVal.Simple;
    ...
    /* [out] */ String_t *auctions)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&MyBay_i_StubDesc,
                  (PFORMAT_STRING) &MyBay_i__MIDL_ProcFormatString.Format[180],
                  ( unsigned char * )&sessionId);
    return ( error_status_t  )_RetVal.Simple;
    ...
    /* [in] */ double bidVal)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&MyBay_i_StubDesc,
                  (PFORMAT_STRING) &MyBay_i__MIDL_ProcFormatString.Format[240],
                  ( unsigned char * )&sessionId);
    return ( error_status_t  )_RetVal.Simple;
    ...
    /* [out] */ unsigned long *countBids)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&MyBay_i_StubDesc,
                  (PFORMAT_STRING) &MyBay_i__MIDL_ProcFormatString.Format[288],
                  ( unsigned char * )&sessionId);
    return ( error_status_t  )_RetVal.Simple;
    ...
    /* [in] */ unsigned long auctionNumber)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&MyBay_i_StubDesc,
                  (PFORMAT_STRING) &MyBay_i__MIDL_ProcFormatString.Format[342],
                  ( unsigned char * )&sessionId);
    return ( error_status_t  )_RetVal.Simple;
    ...
    /* [out] */ String_t *message)
{
    ...
    _RetVal = NdrClientCall2(
                  ( PMIDL_STUB_DESC  )&MyBay_i_StubDesc,
                  (PFORMAT_STRING) &MyBay_i__MIDL_ProcFormatString.Format[384],
                  ( unsigned char * )&sessionId);
    return ( error_status_t  )_RetVal.Simple;
...
static const MIDL_STUB_DESC MyBay_i_StubDesc = 
    {
    (void *)& MyBay_i___RpcClientInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    &hMyBay_i,
    0,
